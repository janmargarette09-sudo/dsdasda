...
<div class="page-toolbar">
    ...
    <div class="toolbar-actions">
        <a href="<?= BASE_URL ?>/modules/subjects/" class="btn btn-outline">
...
<div class="card form-card">
    <div class="card-body">
        <div class="import-info">
            <h3>CSV Upload</h3>
            <p class="text-muted">Upload a file with columns: <code>code, name, description, units, lecture_hours, lab_hours, department, semester, year_level</code></p>
        </div>

        <form id="import-form" enctype="multipart/form-data" data-type="subjects">
            ...
            <div class="form-group">
                <a href="<?= BASE_URL ?>/samples/subjects_template.csv" class="btn btn-sm btn-ghost" download>
